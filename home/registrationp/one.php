                    ...
                    <div class="input-group">
                        ...
                        <div class="Gender">
                            &nbsp; &nbsp; <label for="formCheck2">sex</label>
                                &nbsp; &nbsp; &nbsp;&nbsp;
                             <input type="radio" id="formCheck2" class="check" name="gender"  value = "male" >
                            <label for="formCheck2">Male</label>
                            &nbsp;&nbsp;
                            <input type="radio" id="formCheck2" class="check" name="gender" value = "female">
                        ...
                        <div class="input-field">
                        <input type="text" class="input-box" id="regadress" required name="location">
                            <label for="regadress">Adress</label>
