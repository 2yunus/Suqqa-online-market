    ...
    <header>
      ...
      <input type="checkbox" name="" id="check">
        ...
        <ul>
                ...
                <li><a href="registrationp/item.php">Post</a></li>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '
        <form action="" method="POST" >
            <div style="background-image: url(\'../images/back6.jpg\'); background-size: cover;" class="item-card ' . $itemCategory . '">
                <input type="hidden" class="item-id" name="item_id" value="' . $itemId . '">
                <input type="hidden" class="item-id" name="item_price" value="' . $itemPrice . '">
                <img src="../images/' . $itemImage . '" alt="Item Image">
